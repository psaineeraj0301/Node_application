            ...
            steps {
                script {
                    sshagent(['Github_ssh_key']) {
                        ...
                        ls 
                        ip r
                        ssh -o StrictHostKeyChecking=no ubuntu@172.31.29.68 'docker pull ${imageTag}'
                        ssh -o StrictHostKeyChecking=no ubuntu@172.31.29.68 'docker run -d -p 80:80 ${imageTag}'
                        """
                    }
                }
            }
